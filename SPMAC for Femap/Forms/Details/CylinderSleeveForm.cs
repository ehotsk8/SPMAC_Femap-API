...
namespace SPMAC_for_Femap.Forms.Details
{
    public partial class CylinderSleeveForm : RadForm
    {
        ...
        public CylinderSleeveForm(model FemapModel)
        {
            InitializeComponent();
        ...
        private async Task FindDetail()
        {
            ...
            foreach (var detail in db.CREATEDETAILS.Where(w => w.DetailsSet.DetailsSetId == currentId).Select(s => s.DetailsList))
                if (detail == "Гильза цилиндра") CreateBtn.Enabled = false;
        }
        ...
        private void CreateBtn_Click_Async(object sender, EventArgs e)
        {
            ...
            Directory.CreateDirectory(Status.CurrentDetailsSetDirectory + "/SLEEVE");
            CreateBtn.Enabled = false;
            ui.Create_Async(groupBox1, "Гильза цилиндра");
        }
        ...
        private void pictureBox1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            pictureBox1.Size = new Size(514, 345);
            xPos = e.X; yPos = e.Y;
        }
        ...
        private void CylinderSleeveForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (Status.CurrState != Status.CurrentState.CREATING)
                Status.CurrState = Status.CurrentState.READY;
        }
