...
{
    public partial class ParamConnectingRodForm : RadForm, ICancelModelling
    {
        private readonly model FemapModel;
        private int xPos, yPos;
        private readonly SyncGUI ui;
        private readonly DBServerContext db;

        public ParamConnectingRodForm(model FemapModel)
        {
            InitializeComponent();
        ...
        private async Task FindDetail()
        {
            ...
            foreach (var detail in db.CREATEDETAILS.Where(w => w.DetailsSet.DetailsSetId == currentId).Select(s => s.DetailsList))
                if (detail == "Шатун") CreateBtn.Enabled = false;
        }
        ...
        private void CreateBtn_Click_Async(object sender, EventArgs e)
        {
            ...
            Directory.CreateDirectory(Status.CurrentDetailsSetDirectory + "/ROD");
            CreateBtn.Enabled = false;
            ui.Create_Async(groupBox1, "Шатун");
        }
        ...
        private void pictureBox1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            pictureBox1.Size = new Size(661, 440);
            xPos = e.X; yPos = e.Y;
        }
